...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="glass w-full max-w-md rounded-2xl p-6 relative animate-in fade-in zoom-in duration-200">
        <button 
          onClick={onClose}
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                required
                className="w-full bg-slate-900/50 border border-slate-700 rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
        ...
        <button 
          ...
          className="mt-6 w-full py-2.5 bg-white text-slate-900 hover:bg-slate-100 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
        >
